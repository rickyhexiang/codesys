 ...
 *  </copyright>
 */
#ifndef _CMPGLODONDEMODEP_H_
#define _CMPGLODONDEMODEP_H_

#define COMPONENT_NAME "CmpGlodonDemo"COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpGlodonDemo)
#define COMPONENT_NAME_UNQUOTED CmpGlodonDemo
...
#define CMPID_CmpGlodonDemo		0x2000								/* NOTE: START HERE WITH YOUR COMPONENTIDS (see CmpItf.h */
#define CLASSID_CCmpGlodonDemo	ADDVENDORID(CMP_VENDORID, 0x2000)	/* NOTE: START HERE WITH YOUR CLASSIDS (see CmpItf.h */
#define ITFID_ICmpGlodonDemo		ADDVENDORID(CMP_VENDORID, 0x2000)	/* NOTE: START HERE WITH YOUR INTERFACEIDS (see CmpItf.h */
...
#ifndef CMPGLODONDEMO_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)update_one_task__main, "update_one_task__main", 0xD5DDFCFA, 0x01000000 },\
          { (RTS_VOID_FCTPTR)update_machine_data__main, "update_machine_data__main", 0x93B879B0, 0x01000000 },\
          { (RTS_VOID_FCTPTR)start_one_task__main, "start_one_task__main", 0x7CE1EAB1, 0x01000000 },\
          { (RTS_VOID_FCTPTR)is_internet_connected__main, "is_internet_connected__main", 0xBCD4A05B, 0x01000000 },\
          { (RTS_VOID_FCTPTR)get_task_data__main, "get_task_data__main", 0x72113503, 0x01000000 },\
          { (RTS_VOID_FCTPTR)get_task_count__main, "get_task_count__main", 0x4B225203, 0x01000000 },\
          { (RTS_VOID_FCTPTR)end_one_task__main, "end_one_task__main", 0x68170C11, 0x01000000 },\
          { (RTS_VOID_FCTPTR)end_access_iot__main, "end_access_iot__main", 0x1CA99AFC, 0x01000000 },\
          { (RTS_VOID_FCTPTR)do_access_iot__main, "do_access_iot__main", 0x3E484BF2, 0x01000000 },\
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPGLODONDEMO_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpGlodonDemo__Entry
#endif


#ifdef CPLUSPLUS

class CCmpGlodonDemo : public ICmpGlodonDemo 
{
    public:
        CCmpGlodonDemo() : hCmpGlodonDemo(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpGlodonDemo()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpGlodonDemo *)this);            
            else if (iid == ITFID_ICmpGlodonDemo)
                pItf = dynamic_cast<ICmpGlodonDemo *>(this); 
            else
            {
                if (pResult != NULL)
    ...
    public:
        RTS_HANDLE hCmpGlodonDemo;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpGlodonDemo Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpGlodonDemo_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpGlodonDemo_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
