 ...
 *  </copyright>
 */
#ifndef _CMPPULSEOUTPUTDEP_H_
#define _CMPPULSEOUTPUTDEP_H_

#define COMPONENT_NAME "CmpPulseOutput"COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpPulseOutput)
#define COMPONENT_NAME_UNQUOTED CmpPulseOutput
...
#ifndef CMPPULSEOUTPUT_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)stoppulse__main, "stoppulse__main", 0x4D0AB68B, 0x01000000 },\
          { (RTS_VOID_FCTPTR)setpulsefreq__main, "setpulsefreq__main", 0x1B741B61, 0x01000000 },\
          { (RTS_VOID_FCTPTR)setpulseamountandstart__main, "setpulseamountandstart__main", 0x32C1BCFE, 0x01000000 },\
          { (RTS_VOID_FCTPTR)ispulseover__main, "ispulseover__main", 0xCD4A0220, 0x01000000 },\
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPPULSEOUTPUT_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpPulseOutput__Entry
#endif


#ifdef CPLUSPLUS

class CCmpPulseOutput : public ICmpPulseOutput 
{
    public:
        CCmpPulseOutput() : hCmpPulseOutput(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpPulseOutput()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpPulseOutput *)this);            
            else if (iid == ITFID_ICmpPulseOutput)
                pItf = dynamic_cast<ICmpPulseOutput *>(this); 
            else
            {
                if (pResult != NULL)
    ...
    public:
        RTS_HANDLE hCmpPulseOutput;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpPulseOutput Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpPulseOutput_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpPulseOutput_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
