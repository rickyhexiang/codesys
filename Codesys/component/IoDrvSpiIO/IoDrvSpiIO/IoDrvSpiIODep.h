 ...
 *  </copyright>
 */
#ifndef _IODRVSPIIODEP_H_
#define _IODRVSPIIODEP_H_

#define COMPONENT_NAME "IoDrvSpiIO"COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_IoDrvSpiIO)
#define COMPONENT_NAME_UNQUOTED IoDrvSpiIO
...
#ifndef IODRVSPIIO_DISABLE_EXTREF
...
#define EXPORT_EXTREF_STMT
#endif
#ifndef IODRVSPIIO_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry IoDrvSpiIO__Entry
#endif


#ifdef CPLUSPLUS

class CIoDrvSpiIO : public IIoDrvSpiIO , public ICmpIoDrv , public ICmpIoDrvParameter 
{
    public:
        CIoDrvSpiIO() : hIoDrvSpiIO(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CIoDrvSpiIO()
        {
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((IIoDrvSpiIO *)this);            
            else if (iid == ITFID_IIoDrvSpiIO)
                pItf = dynamic_cast<IIoDrvSpiIO *>(this); 
    ...
    public:
        RTS_HANDLE hIoDrvSpiIO;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* IoDrvSpiIO Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT IoDrvSpiIO_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF IoDrvSpiIO_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
